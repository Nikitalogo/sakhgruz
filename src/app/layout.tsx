...
export const metadata: Metadata = {
  ...
  title: 'Грузоперевозки в Южно-Сахалинске — Грузчики, Фургоны, Кран-балки | САХГРУЗ',
  description:
    'Профессиональные грузоперевозки по Южно-Сахалинску и области. Услуги грузчиков, аренда фургонов и кран-балок. Работаем 24/7 без выходных. Цены от 1000 руб.',
  icons: {
    icon: '/icon.png',
    shortcut: '/icon.png',
    apple: '/icon.png',
  ...
  openGraph: {
    ...
    description: 'Профессиональные грузоперевозки по Южно-Сахалинску и области. Услуги грузчиков, аренда фургонов и кран-балок. Работаем 24/7 без выходных.',
